...
updater.config = {
  CURRENT_VERSION = "1.7",
  VERSION_URL = "https://raw.githubusercontent.com/moosazaib/AndroLua-Easy-UI-Builder/main/virgin.txt",
  WHATSNEW_URL = "https://raw.githubusercontent.com/moosazaib/AndroLua-Easy-UI-Builder/main/what's%20new.txt",
  ZIP_URL = "https://github.com/moosazaib/AndroLua-Easy-UI-Builder/archive/refs/heads/main.zip",
  TARGET_PATH = "/storage/self/primary/解说/Plugins/AndroLua Easy UI Builder/",
  MAIN_FILE = "main.lua",
